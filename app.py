...
if user_menu == 'Country-wise Analysis':
    ...
    if top10_df.empty:
        st.write("No athlete data available for this country.")
    else:
        st.table(top10_df)
...
if user_menu == 'Athlete-wise Analysis':
    ...
    fig, ax = plt.subplots()
    ax = sns.scatterplot(x=temp_df['Weight'], y=temp_df['Height'], hue=temp_df['Medal'], style=temp_df['Medal'], s=60)
    st.title(selected_sport + " - Height vs Weight")        
    st.pyplot(fig)
